...
- **기획 기준 문서**: `docs/planning/GDD.md` — 게임 설계, 밸런스, 시스템 사양의 최신 확정본.
- 코드·에셋·문서가 GDD와 충돌할 경우 GDD를 우선으로 한다.
- GDD 변경 시 반드시 사용자 승인 후 변경 이력(부록)에 기록한다.
